  ...
  <Accordion style={{ background: 'transparent'}} elevation={0}>
        ...
        <AccordionSummary id="list"
          ...
          >
           ...
           <TextField id="standard-basic" sx={{width: "60%"}} label="Search Contacts" variant="standard" value={this.state.search} onChange={this.handleChangeBound}/>
        ...
        <AccordionDetails >
          ...
          <Stack justifyContent="center" m="20" direction="row">
            <Typography variant="body" fontFamily="Arial" sx={{mr:2}}> Filter: </Typography>
             ...
             <FormGroup row>
               <FormControlLabel control={<Switch size="small" onChange={this.handleClickScore} color="primary"/>} label="Lab Members" />
               <FormControlLabel control={<Switch size="small" onChange={this.handleClickTTP} />} label="NRI" />
               <FormControlLabel control={<Switch size="small" onChange={this.handleClickProfit} />} label="Compliance Officers" />
             </FormGroup>
